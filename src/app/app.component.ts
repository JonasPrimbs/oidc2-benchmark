...
export class AppComponent {
   ...
   */
  private async generateTokenRequest(type: 'ES256' | 'ES384' | 'ES512' | 'RS256' | 'RS384' | 'RS512', keyPair: CryptoKeyPair, iss: string, sub: string, aud: string, iat: number, nbf: number, exp: number, nonce: string, tokenClaims: string[], tokenNonce: string, tokenLifetime: number, jti: string): Promise<string> {
    let claimsString = ""
